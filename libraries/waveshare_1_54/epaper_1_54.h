...
private:
    unsigned int pin_rst;                           // Reset
    unsigned int pin_dc;                            // Mosi
    unsigned int pin_cs;                            // Chipselect
    unsigned int pin_busy;                          // Busy
};
